...
def do_nothing(): return None  # pylint: disable=unnecessary-lambda-assignment
def do_nothing_with_self(self): return None  # pylint: disable=unnecessary-lambda-assignment
